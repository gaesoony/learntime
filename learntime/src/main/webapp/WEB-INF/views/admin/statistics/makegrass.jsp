...
<html>
  <head>
    ...
    />
    <script src="${pageContext.request.contextPath}/resources/js/admin/statistics/makegrass.js"></script>
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <div id="content-wrap">
      <div id="admin-category-title" class="shadow-light">공부인증 통계</div>
      <div class="wrapper">
