  ...
  <body>
    ...
    <main class="space-between">
      ...
      <article class="mystudy-article">
        <div class="mystudy-board-title">스터디 정보 관리</div>
        <div>
          <form
            action="${path}/mystudy/manage/info"
            method="post"
            ...
            <main class="study-recruit-main">
                    ...
                    <li class="container-list">
                      ...
                      <div class="container1">
                        ...
                        <div class="select-box relative">
                          ...
                          <div class="selected selected-way">
                            온라인 / 오프라인
                          </div>
                        </div>
                      </div>
                      <div class="container1">
                        ...
                        <div class="select-box relative">
                          <div
                            class="options-container options-container-period"
                          >
                  ...
                  <div class="recruit-question-area">
                    ...
                    <div class="recruit-question-explain hidden">
                      ...
                      <p>
                        ...
                        있으며, 스터디 운영 목적과 무관하게 임의로 수집 및
                        이용한 개인정보는 법률적 문제가 발생할 수 있으므로
                        스터디 가입 질문은 최소한의 내용으로 작성해주시기
                        바랍니다.
                      </p>
                    </div>
                  </div>
              ...
              <section class="btn-section">
                <input
                  ...
                  value="취소"
                  class="cancel-btn"
                  onclick="location.href='${path}/mystudy/main?gno=${groupOne.NO}'"
                />
                <input type="submit" value="수정" class="save-btn" />
              </section>
            </main>
          </form>
        </div>
